...
@Enumerable.Parent(classArray = {LeftClickSkill.class, RightClickSkill.class})
...
public abstract class InteractionSkill extends CooldownSkill {
    public InteractionSkill(boolean consumable, Set<EquipmentSlot> allowedSlots, List<Action> onItemActions, CooldownOptions cooldownOptions) {
