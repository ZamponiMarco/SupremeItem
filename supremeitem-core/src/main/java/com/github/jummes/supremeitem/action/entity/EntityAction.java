...
@Enumerable.Parent(classArray = {DamageAction.class, EffectAction.class, HealAction.class, MessageAction.class,
        PullAction.class, PushAction.class, ConsumeItemAction.class, SetOnFireAction.class,
        BlockEventAction.class, RelativeTeleportAction.class, MoneyAction.class, GiveItemAction.class})
