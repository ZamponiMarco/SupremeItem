...
@Enumerable.Child
@Enumerable.Displayable(name = "&6&lEquals Condition", description = "gui.condition.equals.description", headTexture = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODEzM2E0MjM2MDY2OTRkYTZjOTFhODRlYTY2ZDQ5ZWZjM2EyM2Y3M2ZhOGFmOGNjMWZlMjk4M2ZlOGJiNWQzIn19fQ==")
...
public class EqualsCondition extends NumericCondition {
    ...
    @Serializable(headTexture = ONE_HEAD, description = "gui.action.equals.operand-one")
    private NumericPlaceholder operandOne;
    @Serializable(headTexture = TWO_HEAD, description = "gui.action.equals.operand-two")
